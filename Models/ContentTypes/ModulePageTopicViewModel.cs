...
namespace GoldSim.Web.Models.ContentTypes {
  ...
  ///   topic.
  /// </summary>
  internal sealed record ModulePageTopicViewModel : PageTopicViewModel, ICardViewModel {
    ...
    internal ModulePageTopicViewModel(AttributeDictionary attributes) : base(attributes) {
    ...
    /// </summary>
    internal ModulePageTopicViewModel() { }
