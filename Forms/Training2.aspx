...
\--------------------------------------------------------------------------------------------------------------------------*/
  ...
  //Submission email subject
    Master.EmailSubject         = "Perth Training Session Registration Request";
...
<asp:Content ContentPlaceHolderId="Content" runat="Server">
  ...
  <h2 class="Subtitle">GoldSim Training Session Registration: Perth</h2>
  <h4 >14-16 November 2011</h4>
  <p>We will be holding a 2-day GoldSim training course in Perth, Australia on November 14 and 15, 2011. The third day (November 16) is optional and will cover the Contaminant Transport Module. The <a href="http://mms.netstarter.com/SiteMedia/w3svc450/Uploads/Documents/Cliftons_Facility-Info-Guide_Perth-1.pdf" target="_blank">venue for the training</a> is adjacent to the Perth Convention Center</p>
  <p>The two-day workshop will provide a general introduction to the use of GoldSim. It will be of value to new users, and will also serve as an excellent refresher course (and introduction to new features) for existing users. The optional third day will cover use of the Contaminant Transport Module to support water quality and contaminant transport modeling. A brief agenda can be found <a href="http://www.goldsim.com/downloads/documents/australia_2012.pdf" target="_blank">here</a>.</p>
  <p>The cost will be AUD900 per attendee for the 2-day session and AUD1200 per attendee for the 3-day session. The price includes breakfast and lunch each day.</p>
  ...
  <p>To register for the training session, please fill out and submit this form. We look forward to seeing you in Perth!</p>
  ...
  <fieldset>
    ...
    <%-- COUNTRY SELECTION --%>
    <GoldSimForm:CountrySelection ID="CountrySelection" SelectedValue="Australia" RunAt="Server" />
  ...
  <fieldset>
    ...
    <fieldset ID="APContactInfo">
      ...
      <%-- COUNTRY SELECTION --%>
      <GoldSimForm:CountrySelection ID="APContactCountrySelection" SelectedValue="Australia" ValidationGroup="AccountsPayable" RunAt="Server" />
