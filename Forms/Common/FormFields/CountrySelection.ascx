...
<div class="FieldContainer">
  <label for="CountryList"<%# (IsRequired)? " class=\"Required\"" : "" %>>Country</label>
  <asp:DropDownList ID="CountryList" ValidationGroup=<%# ValidationGroup %> RunAt="Server">
    ...
    <asp:ListItem Value="Nevis">NevIslands</asp:ListItem>
    ...
    <asp:ListItem Value="Wallis &amp; Futana Is">Wallis &amp; Futana Islands</asp:ListItem>
